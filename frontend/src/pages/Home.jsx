...
<section 
  ...
  style={{ paddingTop: '160px' }}  // This line forces it down — no cache can stop it
>
  ...
  {/* This wrapper pushes content down safely */}
  <div className="relative z-10 text-center px-6 max-w-5xl mx-auto mt-20 md:mt-32">
    ...
    >
      Plan Your <span className="text-indigo-200">Dream Trip</span>
    </motion.h1>
    ...
    >
      <a
        href="#auth"
        className="px-12 py-5 bg-white text-indigo-600 font-bold text-xl rounded-full hover:bg-indigo-50 transition shadow-xl hover:shadow-2xl"
      >
    ...
    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="about" className="py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Raahi uses advanced AI to understand your preferences and create perfectly tailored travel itineraries — 
            from hidden gems to must-see landmarks, all in one seamless experience.
          </motion.p>

          <div className="grid md:grid-cols-3 gap-10">
            {[
              { title: "Personalized Itineraries", desc: "Tailored to your interests: culture, food, adventure & more", icon: "🎯" },
              { title: "Smart Scheduling", desc: "Optimized plans with travel time considered", icon: "⏰" },
              { title: "Real Places & Tips", desc: "Local recommendations and transport suggestions", icon: "🗺️" },
            ].map((feature, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
      ...
      <footer className="py-12 text-center text-gray-500 border-t bg-white/50 backdrop-blur">
        <p className="text-sm">
          Built with React • Tailwind • Spring Boot • AI by <span className="font-semibold text-indigo-600">Grok</span>
        </p>
